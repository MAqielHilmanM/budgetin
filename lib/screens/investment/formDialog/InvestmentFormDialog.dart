...
class AddInvestmentFormDialog extends StatelessWidget {
  @override
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 8),
                child: WidgetForm.text("Eg. Food", null, isBordered: true),
              ),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 8),
                child: WidgetText.poppinsLightBlack25(
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 8),
                child: WidgetForm.text("Eg. Rp. 5,000,000", null, isBordered: true),
              ),
              InkWell(
